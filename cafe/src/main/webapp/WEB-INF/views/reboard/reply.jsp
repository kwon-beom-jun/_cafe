...
<table border="0" cellpadding="2" cellspacing="0" width="630">
	...
	<tr>
		<td align="center">
			<img id="writeBtn" name="register" src="${root}/img/board/btn_register.gif" width="42" height="21" border="0" value="" alt="등록"> 
			<a href="javascript:history.back();">
			<img name="cencel" src="${root}/img/board/b_cancel.gif" width="42" height="21" border="0"  value="" alt="취소">
			</a>
		</td>
	</tr>
</table>
