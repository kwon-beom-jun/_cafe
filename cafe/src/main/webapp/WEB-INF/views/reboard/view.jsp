...
$(document).ready(function () {
	...
	// 항상 값들을 전달해야뎀 bcode,pg,key,word.
	// 쿼리스트링하면 한글깨짐 form을 쓰면 인코딩이 알아서 해줌.
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td valign="bottom" nowrap>
			<img
			src="${root}/img/board/btn_write_01.gif" width="64" height="22" class="moveWriteBtn"
			border="0" align="absmiddle" alt="글쓰기">
			<img class="moveReplyBtn"
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr height="28">
		...
		<b><font class="text"> <!-- 제목을 출력 부분 -->${article.subject } </font></b></td>
	</tr>
	<tr>
	...
	<tr height="26">
		...
		:</font> <font class="text_commentnum"><!-- 글 번호를 출력 하는 부분 -->${article.seq }</font> &nbsp; <font
			class="stext">글쓴이 :</font> <a href="javascript:;"
			onClick="showSideView();" class="link_board_02"><!-- 글쓴이를 출력 하는 부분 -->${article.name }</a><br>
		</td>
		<td style="padding-right: 14px" nowrap class="stext">조회 : <font
			class="text_commentnum"><!-- 조회수를 출력 하는 부분 -->${article.hit }</font> &nbsp; 스크랩 : <font
			class="text_commentnum">0</font> &nbsp; 날짜 : <font
			class="text_commentnum"><!-- 날짜 출력하는 부분 -->${article.logtime }</font></td>
	</tr>
	<tr>
		<td class="bg_board_title_02" colspan="2" height="1"
			style="overflow: hidden; padding: 0px"></td>
...
<table border="0" cellpadding="15" cellspacing="0" width="100%">
	<tr valign="top">
		...
		<P><!-- 글 내용이 들어 오는 부분 -->${article.content }</P>
