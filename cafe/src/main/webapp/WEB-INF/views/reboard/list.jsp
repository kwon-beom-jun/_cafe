...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	<tr>
		<td align="center" class="text_gray"><!-- 글번호 출력하는 부분 -->${article.seq}</td>
		<td></td>
		...
		<td style="word-break: break-all;"><a href=""
			class="link_board_03"><!-- 글 제목을 출력 하는 부분 -->${article.subject}&nbsp;&nbsp;&nbsp;</a></td>
		<td></td>
		<td style="word-break: break-all;"><a href="javascript:;"
			onClick="showSideView();" class="link_board_04"><!-- 작성자를 출력 하는 부분 -->${article.name}</a></td>
		<td></td>
		<td align="center" class="text_gray"><!-- 조회수를 출력 하는 부분 -->${article.hit }</td>
		<td></td>
		<td align="center" class="text_gray"><!-- 작성 일자를 출력 하는 부분 -->${article.logtime }</td>
	</tr>
