...
$(document).ready(function() {
   ...
   $(".moveListBtn").click(function() {   /* 목록을 누르면? 내가 보던 페이지로 이동 */
      $("#bcode").val("${bcode}");
   ...
   $("#myListBtn").click(function() {   /* 나의 페이지 보기 */
      $("#bcode").val("${bcode}");
      $("#pg").val("1");
      $("#key").val("id");
...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
   ...
   <tr>
      ...
      <td style="word-break: break-all;">
      	<img alt="댓글" src="${root }/img/board/blank.gif" width="${article.lev * 15 }" height="1">
      	<!-- 글 제목 -->
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
   ...
   <tr>
      ...
      <img src="${root}/img/board/sbtn_s.gif" width="32" id="searchBtn" height="18" border="0" align="absmiddle" alt="검색"> 
      
      <c:if test="${userInfo != null }">
      <img src="${root}/img/board/sbtn_mytext.gif" width="82" id="myListBtn" height="20" align="absmiddle" alt="내가 쓴 글 보기">
      </c:if>
